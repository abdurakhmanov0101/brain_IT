...
import { Bell, Send, MessageCircle, AlertTriangle, CheckCircle, Clock, ChevronRight } from 'lucide-react';
        ...
        <div className="divide-y divide-slate-100 dark:divide-dark-border">
          {notifs.map((n) => (
            <div key={n.id} className="px-5 py-4 flex items-center gap-4">
              <div className={`p-2 rounded-lg ${n.channel === 'telegram' ? 'bg-blue-50 dark:bg-blue-900/20 text-blue-500' : 'bg-green-50 dark:bg-green-900/20 text-green-500'}`}>
