  ...
  ({ studentName, courseName, issueDate, certificateNumber, verifyUrl }, ref) => {
    return (
      ...
      >
        ...
        <div className="absolute top-0 left-0 w-full h-4 bg-gradient-to-r from-emerald-800 via-emerald-600 to-emerald-800"></div>
        <div className="absolute bottom-0 left-0 w-full h-4 bg-gradient-to-r from-emerald-800 via-emerald-600 to-emerald-800"></div>
        ...
        {/* Content */}
        <div className="flex-1 flex flex-col items-center justify-center text-center px-32 relative z-10 mt-4">
          <p className="text-emerald-600 font-bold tracking-[0.4em] uppercase text-sm mb-6 flex items-center gap-4">
            <span className="w-12 h-[1px] bg-emerald-300"></span>
        ...
        {/* Footer */}
        <div className="flex justify-between items-end pb-16 px-24 relative z-10 w-full">
          {/* Left: Date */}
          ...
          {/* Center: Signature & Seal */}
          <div className="flex flex-col items-center relative w-64">
            {/* Stamp / Seal */}
            <div className="absolute -top-12 -right-6 opacity-90 drop-shadow-md mix-blend-multiply pointer-events-none z-0">
            ...
            <div className="w-full border-b-2 border-emerald-800/20 mb-3 flex justify-center items-end h-16 relative z-10">
          ...
          {/* Right: QR Code */}
          <div className="flex flex-col items-center p-3 bg-white rounded-xl shadow-lg shadow-emerald-900/5 border border-emerald-100 w-28 shrink-0 relative z-10">
