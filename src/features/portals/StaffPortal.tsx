...
export const StaffPortal: React.FC = () => {
  ...
  return (
    <div className="space-y-6 max-w-4xl mx-auto">
      {/* Header */}
      <div className="relative overflow-hidden rounded-3xl bg-gradient-to-r from-indigo-600 via-violet-600 to-purple-700 p-8 text-white">
        ...
        <div className="relative z-10 flex flex-col md:flex-row items-center gap-6">
          ...
          <div className="text-center md:text-left">
            ...
            <p className="text-indigo-200 flex items-center gap-2 justify-center md:justify-start">
              <Briefcase className="w-4 h-4" /> {myProfile.role}
            </p>
            <p className="text-indigo-300 text-sm flex items-center gap-2 justify-center md:justify-start mt-1">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
        ...
        <div className="bg-white dark:bg-dark-card border border-indigo-200 dark:border-indigo-900/50 rounded-2xl p-6 relative overflow-hidden group hover:border-indigo-400 transition-all hover:shadow-lg hover:shadow-indigo-500/10">
          ...
          <p className="text-3xl font-black text-indigo-600">{fmtMoney(currentBalance)}</p>
          <p className="text-xs text-indigo-500 font-semibold mt-2">Hisobingizga tushgan summa</p>
        </div>
      ...
      <div className="bg-white dark:bg-dark-card border border-slate-200 dark:border-dark-border rounded-2xl p-6">
        <div className="flex items-center justify-between mb-3">
          <h3 className="font-bold text-slate-800 dark:text-white flex items-center gap-2"><TrendingUp className="w-5 h-5 text-indigo-500" /> Oylik To'lov Holati</h3>
          <span className="text-sm font-black text-indigo-600">{monthlyPay > 0 ? Math.min(100, Math.round((currentBalance / monthlyPay) * 100)) : 0}%</span>
        </div>
      ...
      <div className="bg-white dark:bg-dark-card border border-slate-200 dark:border-dark-border rounded-2xl p-6">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
          ...
          <div className="bg-slate-50 dark:bg-slate-800/40 rounded-xl p-4">
            ...
            <p className="text-sm font-bold text-indigo-600 dark:text-indigo-400 mt-1">{myProfile.role}</p>
          </div>
          <div className="bg-slate-50 dark:bg-slate-800/40 rounded-xl p-4">
