...
/* ══════════════════════════════════════
  ...
  return (
    ...
    >
      ...
      {/* Navbar spacer — fixed header leaves the flow */}
            ...
            <motion.div variants={stagger} className="flex flex-wrap justify-center gap-5">
              {projects.slice(0, 6).map((project: Project) => (
                <motion.div key={project.id} variants={fadeUp} whileHover={{ y: -5 }}
                  className="group rounded-2xl p-5 transition-all duration-300 cursor-default w-full sm:w-[calc(50%-10px)] lg:w-[calc(33.333%-14px)]"
                  style={{ background: 'rgba(255,255,255,0.04)', border: '1px solid rgba(255,255,255,0.08)' }}>
        ...
        <div className="relative overflow-hidden">
          <div className="filmstrip-track">
            {[...team, ...team].map((member, i) => (
              <div key={i} className="shrink-0 w-72 mx-3 group/card" style={{ height: '520px' }}>
                <div className="rounded-2xl overflow-hidden h-full flex flex-col" style={{
                  ...
                  <div className="p-4 flex flex-col flex-1 overflow-hidden">
                    ...
                    <div className="mb-2" style={{ minHeight: '56px' }}>
                      <p className="text-[11px] text-slate-400 leading-relaxed line-clamp-3">{member.bio}</p>
                      <button
              ...
              <div className="space-y-4">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-slate-400">Surxondaryo vil., Termiz shahri, Yubileyny, Lola kafe ro'parasi</p>
                  </div>
                </div>
                <div className="flex items-start gap-3">
                  <div className="h-8 w-8 rounded-xl flex items-center justify-center shrink-0 mt-0.5"
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-16 py-14 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10">
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-2 text-xs text-slate-500">
              <p className="flex items-center gap-2"><MapPin className="h-3.5 w-3.5 text-blue-500 shrink-0" />Termiz shahri, Yubileyny</p>
