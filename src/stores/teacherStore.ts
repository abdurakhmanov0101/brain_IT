...
export const initialTeachers: Teacher[] = [
  { id: 'tr1', fullName: 'Bobur Akbarov',   phone: '+998901112233', email: 'bobur@brainit.uz',   photo: 'https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?w=80&h=80&fit=crop', courseIds: ['ac2'], groupIds: ['g1', 'g2', 'g3', 'g4', 'g5'], hiredDate: '2024-09-01', status: 'active',   specialization: 'Frontend',           username: 'bobur',   password: 'Bobur@2025',   coins: 100, salaryPercentage: 35, salaryBalance: 0 },
  { id: 'tr2', fullName: 'Jasur Shodiev',    phone: '+998902223344', email: 'jasur@brainit.uz',   photo: 'https://images.unsplash.com/photo-1519085360753-af0119f7cbe7?w=80&h=80&fit=crop', courseIds: ['ac3'], groupIds: ['g6', 'g7', 'g8', 'g9', 'g10'], hiredDate: '2024-09-01', status: 'active',   specialization: 'Backend',            username: 'jasur',   password: 'Jasur@2025',   coins: 100, salaryPercentage: 40, salaryBalance: 0 },
